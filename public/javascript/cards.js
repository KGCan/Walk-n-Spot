...
// send body data to BE (BE will run if/else & for loops to find trails)
...
async function searchFormHandler(event) {
  ...
  const body = { cityInput: city_input, animalInput: animal_input }
  ...
  const response = await fetch('/api/result', {
    ...
    //this is how getting data to BE
...
//       var userInput = { cityInput: city_name, animalInput: animal_input }
